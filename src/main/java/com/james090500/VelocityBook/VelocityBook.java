...
@Plugin(id = "velocitybook", name = "VelocityBook", version = "1.3.1", description = "Books for the entire proxy", authors = { "james095000" }, dependencies = { @Dependency(id = "protocolize") })
